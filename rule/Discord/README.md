...
domain
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Discord/Discord_Domain.mrs
```

classical
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Discord/Discord.yaml
```
