...
domain
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/PayPal/PayPal_Domain.mrs
```

classical
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/PayPal/PayPal.yaml
```
