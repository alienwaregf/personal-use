...
- **Domain 规则 (必须同时使用)**: [Hijacking_Domain.mrs](https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/Hijacking/Hijacking_Domain.mrs)
  ```text
  https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/Hijacking/Hijacking_Domain.mrs
  ```
- **IP 规则 (必须同时使用)**: [Hijacking_IP.mrs](https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/Hijacking/Hijacking_IP.mrs)
  ```text
