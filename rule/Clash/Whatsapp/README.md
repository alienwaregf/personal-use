...
Domain 规则（必须同时使用）Whatsapp_Domain.mrs
...
Classical 规则（单独使用）Whatsapp.yaml
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/Whatsapp/Whatsapp.yaml
## 子规则/排除规则
