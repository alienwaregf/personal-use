...
- **Domain 规则 (必须同时使用)**: [ByteDance_Domain.mrs](https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/ByteDance/ByteDance_Domain.mrs)
  ```text
  https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/ByteDance/ByteDance_Domain.mrs
  ```
- **IP 规则 (必须同时使用)**: [ByteDance_IP.mrs](https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/ByteDance/ByteDance_IP.mrs)
  ```text
  https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/ByteDance/ByteDance_IP.mrs
  ```
