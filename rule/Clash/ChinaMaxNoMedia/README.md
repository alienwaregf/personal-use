...
Domain 规则（必须同时使用）ChinaMaxNoMedia_Domain.mrs
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/ChinaMaxNoMedia/ChinaMaxNoMedia_Domain.mrs

IP 规则（必须同时使用）ChinaMaxNoMedia_IP.mrs
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/ChinaMaxNoMedia/ChinaMaxNoMedia_IP.mrs

Classical 规则（单独使用）ChinaMaxNoMedia_Classical.yaml
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/ChinaMaxNoMedia/ChinaMaxNoMedia_Classical.yaml
## 子规则/排除规则
