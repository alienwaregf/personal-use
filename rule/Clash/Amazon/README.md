...
- **Domain 规则 (必须同时使用)**: [Amazon_Domain.mrs](https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/Amazon/Amazon_Domain.mrs)
  ```text
  https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/Amazon/Amazon_Domain.mrs
  ```
- **IP 规则 (必须同时使用)**: [Amazon_IP.mrs](https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/Amazon/Amazon_IP.mrs)
  ```text
  https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/Amazon/Amazon_IP.mrs
  ```
