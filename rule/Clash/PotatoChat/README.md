...
Domain 规则（必须同时使用）
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/PotatoChat/PotatoChat_Domain.mrs
```

IP 规则（必须同时使用）
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/PotatoChat/PotatoChat_IP.mrs
```

Classical 规则（单独使用）
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/PotatoChat/PotatoChat.yaml
```
...
https://ghproxy.com/https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/PotatoChat/PotatoChat.yaml
...
https://ghproxy.com/https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/release/rule/Clash/PotatoChat/PotatoChat.yaml
