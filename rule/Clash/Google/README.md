...
- **Domain 规则 (必须同时使用)**: [Google_Domain.mrs](https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/Google/Google_Domain.mrs)
  ```text
  https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/Google/Google_Domain.mrs
  ```
- **IP 规则 (必须同时使用)**: [Google_IP.mrs](https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/Google/Google_IP.mrs)
  ```text
  https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/Google/Google_IP.mrs
  ```
