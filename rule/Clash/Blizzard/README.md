...
Domain 规则（必须同时使用）Blizzard_Domain.mrs
...
Classical 规则（单独使用）Blizzard_No_Resolve.yaml
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/Blizzard/Blizzard_No_Resolve.yaml
## 子规则/排除规则
