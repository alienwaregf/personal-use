...
- **Domain 规则 (必须同时使用)**: [YouTube_Domain.mrs](https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/YouTube/YouTube_Domain.mrs)
  ```text
  https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/YouTube/YouTube_Domain.mrs
  ```
- **IP 规则 (必须同时使用)**: [YouTube_IP.mrs](https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/YouTube/YouTube_IP.mrs)
  ```text
  https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/YouTube/YouTube_IP.mrs
  ```
