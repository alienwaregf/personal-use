...
Domain 规则（必须同时使用）Spotify_Domain.mrs
...
Classical 规则（单独使用）Spotify_No_Resolve.yaml
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/Spotify/Spotify_No_Resolve.yaml
## 子规则/排除规则
