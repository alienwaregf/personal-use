...
Domain 规则（必须同时使用）IPTVMainland_Domain.mrs
...
Classical 规则（单独使用）IPTVMainland_Classical.yaml
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/IPTVMainland/IPTVMainland_Classical.yaml
## 子规则/排除规则
