...
- **Domain 规则 (必须同时使用)**: [Twitch_Domain.mrs](https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/Twitch/Twitch_Domain.mrs)
  ```text
  https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/Twitch/Twitch_Domain.mrs
  ```
- **IP 规则 (必须同时使用)**: [Twitch_IP.mrs](https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/Twitch/Twitch_IP.mrs)
  ```text
  https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/Twitch/Twitch_IP.mrs
  ```
