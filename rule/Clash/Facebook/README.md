...
- **Domain 规则 (必须同时使用)**: [Facebook_Domain.mrs](https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/Facebook/Facebook_Domain.mrs)
  ```text
  https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/Facebook/Facebook_Domain.mrs
  ```
- **IP 规则 (必须同时使用)**: [Facebook_IP.mrs](https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/Facebook/Facebook_IP.mrs)
  ```text
  https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/Facebook/Facebook_IP.mrs
  ```
