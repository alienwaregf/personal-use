...
- **Domain 规则 (必须同时使用)**: [ProxyLite_Domain.mrs](https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/ProxyLite/ProxyLite_Domain.mrs)
- **IP 规则 (必须同时使用)**: [ProxyLite_IP.mrs](https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/ProxyLite/ProxyLite_IP.mrs)
