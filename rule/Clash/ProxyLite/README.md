...
```text
[https://raw.githubusercontent.com/](https://raw.githubusercontent.com/)alienwaregf/personal-use/main/rule/Clash/ProxyLite/ProxyLite_Domain.mrs
```

**IP 规则 (必须同时使用):**

```text
[https://raw.githubusercontent.com/](https://raw.githubusercontent.com/)alienwaregf/personal-use/main/rule/Clash/ProxyLite/ProxyLite_IP.mrs
```
