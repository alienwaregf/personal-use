...
Domain 规则（必须同时使用）ClubhouseIP_Domain.mrs
...
Classical 规则（单独使用）ClubhouseIP.yaml
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/ClubhouseIP/ClubhouseIP.yaml
## 子规则/排除规则
