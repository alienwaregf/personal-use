...
Domain 规则（必须同时使用）ChinaTest_Domain.mrs
...
Classical 规则（单独使用）ChinaTest_Classical.yaml
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/ChinaTest/ChinaTest_Classical.yaml
## 子规则/排除规则
