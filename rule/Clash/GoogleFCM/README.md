...
- **Domain 规则 (必须同时使用)**: [GoogleFCM_Domain.mrs](https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/GoogleFCM/GoogleFCM_Domain.mrs)
- **IP 规则 (必须同时使用)**: [GoogleFCM_IP.mrs](https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/GoogleFCM/GoogleFCM_IP.mrs)
