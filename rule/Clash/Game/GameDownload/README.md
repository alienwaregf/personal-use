...
- **Domain 规则**: [GameDownload_Domain.mrs](https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/Game/GameDownload/GameDownload_Domain.mrs)
  ```text
  https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/Game/GameDownload/GameDownload_Domain.mrs
  ```
