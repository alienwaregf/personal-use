...
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/Cloud/CloudGlobal/CloudGlobal_Domain.mrs
```

**IP 规则 (必须同时使用):**

```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/Cloud/CloudGlobal/CloudGlobal_IP.mrs
```

**Classical 规则 (单独使用):**

```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/Cloud/CloudGlobal/CloudGlobal_Classical.mrs
```
