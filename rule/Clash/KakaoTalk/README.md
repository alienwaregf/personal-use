...
Domain 规则（必须同时使用）KakaoTalk_Domain.mrs
...
Classical 规则（单独使用）KakaoTalk.yaml
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Clash/KakaoTalk/KakaoTalk.yaml
## 子规则/排除规则
