...
domain
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/ChinaDirect/ChinaDirect_Domain.mrs
```

classical
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/ChinaDirect/ChinaDirect.yaml
```
