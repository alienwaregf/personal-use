...
domain
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Twitch/Twitch_Domain.mrs
```

ipcidr
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Twitch/Twitch_IP.mrs
```

classical
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Twitch/Twitch.yaml
```
