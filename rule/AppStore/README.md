...
domain
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/AppStore/AppStore_Domain.mrs
```

classical
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/AppStore/AppStore.yaml
```
