...
domain
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Spotify/Spotify_Domain.mrs
```

ipcidr
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Spotify/Spotify_IP.mrs
```

classical
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Spotify/Spotify.yaml
```
