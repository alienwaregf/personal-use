...
domain
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/DMM/DMM_Domain.mrs
```

ipcidr
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/DMM/DMM_IP.mrs
```
