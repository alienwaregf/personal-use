...
domain
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/GitHub/GitHub_Domain.mrs
```

classical
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/GitHub/GitHub.yaml
```
