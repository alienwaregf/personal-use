...
domain
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/IPTVMainland/IPTVMainland_Domain.mrs
```

ipcidr
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/IPTVMainland/IPTVMainland_IP.mrs
```

classical
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/IPTVMainland/IPTVMainland_Classical.yaml
```
