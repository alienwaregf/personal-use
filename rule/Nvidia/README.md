...
domain
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Nvidia/Nvidia_Domain.mrs
```

classical
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Nvidia/Nvidia.yaml
```
