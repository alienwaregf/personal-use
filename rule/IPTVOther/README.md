...
domain
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/IPTVOther/IPTVOther_Domain.mrs
```

ipcidr
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/IPTVOther/IPTVOther_IP.mrs
```

classical
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/IPTVOther/IPTVOther_Classical.yaml
```
