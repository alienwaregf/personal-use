...
ipcidr
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/GoogleFCM/GoogleFCM_IP.mrs
```

classical
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/GoogleFCM/GoogleFCM.yaml
```
