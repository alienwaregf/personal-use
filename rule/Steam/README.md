...
domain
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Steam/Steam_Domain.mrs
```

classical
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Steam/Steam.yaml
```
