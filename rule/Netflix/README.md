...
domain
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Netflix/Netflix_Domain.mrs
```

ipcidr
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Netflix/Netflix_IP.mrs
```

classical
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Netflix/Netflix_Classical.yaml
```
