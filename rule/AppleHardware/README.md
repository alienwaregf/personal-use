...
domain
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/AppleHardware/AppleHardware_Domain.mrs
```

classical
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/AppleHardware/AppleHardware.yaml
```
