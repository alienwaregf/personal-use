...
domain
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Twitter/Twitter_Domain.mrs
```

ipcidr
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Twitter/Twitter_IP.mrs
```

classical
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Twitter/Twitter.yaml
```
