...
domain
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Facebook/Facebook_Domain.mrs
```

ipcidr
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Facebook/Facebook_IP.mrs
```

classical
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Facebook/Facebook.yaml
```
