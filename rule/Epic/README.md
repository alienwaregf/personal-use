...
domain
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Epic/Epic_Domain.mrs
```

classical
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Epic/Epic.yaml
```
