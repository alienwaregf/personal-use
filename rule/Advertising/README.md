...
ipcidr
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Advertising/Advertising_IP.mrs
```

classical
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Advertising/Advertising_Classical.yaml
```
