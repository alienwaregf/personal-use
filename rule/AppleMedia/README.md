...
domain
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/AppleMedia/AppleMedia_Domain.mrs
```

classical
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/AppleMedia/AppleMedia.yaml
```
