...
domain
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Cloudflare/Cloudflare_Domain.mrs
```

ipcidr
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Cloudflare/Cloudflare_IP.mrs
```

classical
```text
https://raw.githubusercontent.com/alienwaregf/personal-use/main/rule/Cloudflare/Cloudflare.yaml
```
